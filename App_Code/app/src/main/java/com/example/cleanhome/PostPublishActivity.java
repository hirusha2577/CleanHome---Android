...
public class PostPublishActivity extends AppCompatActivity {
    ...
    private TextInputEditText postDis;
    private Button image_choose, postuploadBtn;
        ...
        postuploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(description)){
                    Toast.makeText(PostPublishActivity.this, "Enter description...", Toast.LENGTH_SHORT).show();
                }
                if(image_rui == null){
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                hashMap.put("id", uid);//ok
                                hashMap.put("name", name );//ok
                                ...
                                ref.child(timestamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(PostPublishActivity.this, "Post published", Toast.LENGTH_SHORT).show();
                                                postDis.setText("");
                                                postImage.setImageURI(null);
                                                image_rui = null;
                                                Intent intent = new Intent(PostPublishActivity.this, MainActivity.class);
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                pd.dismiss();
                                                Toast.makeText(PostPublishActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
